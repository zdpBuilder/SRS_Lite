...
public class ApplicationGUI {
	...
	IProfessorDAO professorDAO = new ProfessorDAOImpl();
	IStudentDAO studentDAO = new StudentDAOImpl();
	ICourseDAO courseDAO = new CourseDAOImpl();
	IScheduledCourseDAO scheduledCourseDAO = new ScheduledCourseDAOImpl();
	...
	public ApplicationGUI() {
		...
		ITeachingAssignmentDAO tAssignmentDAO = new TeachingAssignmentDAOImpl();
	...
	private void initialize() {
		...
		for (ScheduledCourse scheduledCourse : scheduledCourseDAO.getAllMapStoreData()) {
		...
		for (Student student : studentDAO.getAllListStoreData()) {
